 ...
 *       &lt;sequence>
 *         &lt;element name="action" type="{http://soap.sforce.com/2006/04/metadata}KnowledgeWorkflowAction"/>
...
@XmlType(name = "WorkflowKnowledgePublish", namespace = "http://soap.sforce.com/2006/04/metadata", propOrder = {
    "action",
    "description",
    "label",
    "language",
